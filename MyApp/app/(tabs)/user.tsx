		...
		<SafeAreaView className='flex-1 bg-night-dark'>
			<ScrollView
				...
				{isAdmin && (
					<View className='bg-night-gray rounded-2xl p-4 border border-white/10 shadow-lg mb-4'>
						...
						<Pressable
							...
							className='mb-3 bg-accent-teal rounded-xl py-3 items-center justify-center shadow-md shadow-black/40'>
						...
						<Pressable
							onPress={() => router.navigate("/(tabs)/editEventsList")}
							className='bg-accent-teal rounded-xl mb-3 py-3 items-center justify-center shadow-md shadow-black/40'>
							<Text className='text-white text-base font-bold'>
								Edytuj Event
							</Text>
						</Pressable>
						...
						<Pressable
							...
							className='bg-accent-teal rounded-xl py-3 items-center justify-center shadow-md shadow-black/40'>
							<Text className='text-white text-base font-bold'>Dodaj News</Text>
						</Pressable>

						<Pressable
							onPress={() => router.navigate("/(tabs)/editNewsList")}
							className='bg-accent-teal rounded-xl mt-3 py-3 items-center justify-center shadow-md shadow-black/40'>
							<Text className='text-white text-base font-bold'>
								Edytuj News
							</Text>
						</Pressable>
				...
				<Pressable
					...
					className='mt-2 bg-accent-teal rounded-xl py-3 items-center justify-center shadow-md shadow-black/40'>
